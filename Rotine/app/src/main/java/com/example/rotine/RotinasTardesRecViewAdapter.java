...
public class RotinasTardesRecViewAdapter extends RecyclerView.Adapter<RotinasTardesRecViewAdapter.ViewHolder> {

    private ArrayList<Rotina> contacts = new ArrayList<>();
    private Context context;

    public RotinasTardesRecViewAdapter(Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup/*parent of all layout types*/ parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.rotina_tarde_list_item, parent, false);
