...
public class RotinasMatinaisRecViewAdapter extends RecyclerView.Adapter<RotinasMatinaisRecViewAdapter.ViewHolder> {

    private ArrayList<Rotina> contacts = new ArrayList<>();
    private Context context;

    public RotinasMatinaisRecViewAdapter(Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup/*parent of all layout types*/ parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.rotina_matinal_list_item, parent, false);
